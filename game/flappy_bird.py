...
Navigate the bird through pipes by pressing the spacebar.
"""
...
class Bird:
    """Bird class that handles player movement and physics."""
...
class Pipe:
    ...
    def __init__(self, x):
        """Initialize a pipe at the given x position."""
        self.x = x
...
def main():
    ...
    # Pre-initialize mixer for better MP3 compatibility
